...
<div class="style-banner" style="overflow:hidden;">
    <a href="#"><img src="${pageContext.request.contextPath}/images/banner-tu2.gif" /></a>
</div>
...
<div class="about-us-con w1200">
    <div class="us-info1">
        <div class="us-if1-left f-l">
            <a href="#"><img src="${pageContext.request.contextPath}/images/about-us-tu1.gif" /></a>
        </div>
    ...
    <div class="us-info3">
        <div class="ue3-top">
            <div class="us-left f-l">
                <a href="#"><img src="${pageContext.request.contextPath}/images/about-us-tu3.gif" /></a>
            </div>
            <div class="us-right f-l">
                <img src="${pageContext.request.contextPath}/images/about-us-tu4.gif" />
                <div class="us3-font">
