...
<div class="shop-page-con w1200">
    ...
    <div class="shop-pg-right f-r">
        ...
        <div class="shop-right-con">
            <ul class="real-ul">
                <li>
                    <a href="#"><img src="${pageContext.request.contextPath}/images/ktv-li-tu5.gif" /></a>
                    <a href="#" class="rl-tit">hello  kitty主题包房</a>
                    <span class="rl-sp1">新站区</span>
                    <p>意式墅区美宅 纯正意大利风情 </p>
                    <span class="rl-sp2">5980元/m2</span>
                    <button class="btn1">立即预约</button>
                    <button class="btn2">加入购物车</button>
                </li>
                <li>
                    <a href="#"><img src="${pageContext.request.contextPath}/images/ktv-li-tu6.gif" /></a>
                    <a href="#" class="rl-tit">hello  kitty主题包房</a>
                    <span class="rl-sp1">新站区</span>
                    <p>意式墅区美宅 纯正意大利风情 </p>
                    <span class="rl-sp2">5980元/m2</span>
                ...
                <li>
                    <a href="#"><img src="${pageContext.request.contextPath}/images/ktv-li-tu7.gif" /></a>
                    <a href="#" class="rl-tit">hello  kitty主题包房</a>
                    <span class="rl-sp1">新站区</span>
                    <p>意式墅区美宅 纯正意大利风情 </p>
                    <span class="rl-sp2">5980元/m2</span>
                ...
                <li style="margin-right:0;">
                    <a href="#"><img src="${pageContext.request.contextPath}/images/ktv-li-tu8.gif" /></a>
                    <a href="#" class="rl-tit">hello  kitty主题包房</a>
                    <span class="rl-sp1">新站区</span>
                    <p>意式墅区美宅 纯正意大利风情 </p>
                    <span class="rl-sp2">5980元/m2</span>
